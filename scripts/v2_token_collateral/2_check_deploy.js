...
const ProxyMedianizer = artifacts.require('./ProxyV2TokenCollateralTecPriceProvider.sol');
...
module.exports = async callback => {
  try {
    ...
    console.log(`MoC Medianizer from: ${config.proxyAddresses.ProxyV2TecPrice}`);

    // Get value from contract
    const proxyMedianizer = await ProxyMedianizer.at(config.proxyAddresses.ProxyV2TecPrice);
