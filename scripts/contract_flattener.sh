...
CONTRACTS="contracts/ProxyMoCMedianizer.sol contracts/ProxyMedianizerMocStateCalculatedPrice.sol contracts/ProxyDummyOracle.sol zos-lib/contracts/upgradeability/AdminUpgradeabilityProxy.sol contracts/ProxyMedianizerBproUsdConversion2.sol contracts/ProxyCoinPairPriceBproUsdConversion2.sol contracts/ProxyOracleBproUsd2.sol"
